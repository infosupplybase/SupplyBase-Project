...
<FooterColumn title="SOCIAL LINKS" id="ft-social">
...
{showPrivacy && (
  ...
  <ul>
    ...
    <li>Cookies may help us understand how visitors use our website.</li>
  ...
  <p>
    ...
    The content is provided for general information and does not
    by itself form a contract. Information about services, projects,
    materials, pricing, and timelines may change depending on the
  ...
  <h3>IMAGES AND PROJECT CONTENT</h3>
  <p>
  ...
  <p>
    ...
    encouraged to review the Privacy Policy to understand how
