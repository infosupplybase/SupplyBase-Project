...
const paths = {
  ...
  'eye-off': (
    <>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.2A10.6 10.6 0 0 1 12 5c6.4 0 10 6 10 6a13.6 13.6 0 0 1-3.4 3.9M6.6 6.6C4 8.3 2 12 2 12s3.6 6 10 6c1.3 0 2.5-.2 3.6-.6" />
      <path d="M9.9 10.1a2.7 2.7 0 0 0 3.9 3.9" />
    </>
  ),
  info: (
    <>
