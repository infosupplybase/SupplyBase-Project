    ...
    return configSteps
      ...
      .map((step, i) => {
        ...
        if (step.type === 'addon') {
          ...
          const opts = optionsFor(step.questionKey).filter(
            (o) => chosen.includes(o.value)
          );
      ...
      configSteps.forEach((step) => {
        ...
        if (step.type === 'brand') {
          if (answers.paint_brand) {
            const opt = optionsFor(
              'paint_brand'
            ).find(
              (o) =>
                o.value === answers.paint_brand
            );
          ...
          <div className="wizard-card">
            <div className="confirmed">
              ...
              <p>
                ...
                We&rsquo;ll inspect the walls,
                suggest the best solution and give
                you a final quotation.
              </p>
            ...
            displayFlow?.closing && (
              <div className="pnt-closing">
                <span className="pnt-closing-eyebrow">
                  RENOVATION PAINTING BY
                  SUPPLYBASE
                </span>

                <h2>
                  {displayFlow.closing.heading}
                </h2>
...
function FlowTopBar({
  ...
  return (
    ...
    >
      ...
      <a
        href={`https://wa.me/${contact.phoneRaw}?text=${helpMessage}`}
        target="_blank"
        rel="noopener noreferrer"
        className={
          plain
