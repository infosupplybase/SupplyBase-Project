...
//     subServices: [
//   { name: 'Full Home Interior', text: '...' },      // ✅ Matches image
//   { name: 'Living Room', text: '...' },             // ✅ Matches image
//   { name: 'Office', text: '...' },                  // ✅ Matches image
//   { name: 'Modular Kitchen', text: '...' },         // ✅ Matches image
//   { name: 'Wardrobe', text: '...' },                // ✅ Matches image
//   { name: 'Dining Area', text: '...' },             // ✅ Matches image
//   { name: 'Bedroom Interior', text: '...' },        // ✅ Matches image
//   { name: 'Renovation', text: '...' },              // ✅ Matches image
// ],
//     highlights: [
...
export const services = [
  ...
  /* ------------------------------------------------------------------ 03 */
  {
    ...
    gallery: ['/assets/projects/modern-interior.svg', '/assets/services/interior-design.svg'],
    subServices: [
      { name: 'Full Home Interior', text: 'Complete interiors for the entire home — living, dining, bedrooms, kitchen and balconies.' },
      { name: 'Living Room', text: 'TV units, feature walls, false ceiling, lighting and seating layouts.' },
      { name: 'Office', text: 'Workstations, cabins, reception areas, meeting rooms and storage.' },
      ...
      { name: 'Dining Area', text: 'Dining tables, crockery units, feature lighting and wall finishes.' },
      { name: 'Bedroom Interior', text: 'Beds, storage, headboard panelling, wardrobes and lighting.' },
      { name: 'Renovation', text: 'Complete renovation of existing interiors — from layout changes to fresh finishes.' },
    ],
    highlights: [
      '3D interior views approved before any material is cut',
      'In-house furniture work — no third-party carpenter coordination',
  ...
  /* ------------------------------------------------------------------ 04 */
  {
    ...
    gallery: ['/assets/services/painting.svg'],
    subServices: [
      { name: 'Full Home Painting', text: 'Complete interior or exterior painting for the entire home.' },
      { name: 'Renovation Painting', text: 'Repainting of old or damaged walls with proper surface treatment.' },
      { name: 'Room Painting', text: 'Single room painting — bedroom, living room, kitchen or office.' },
      { name: 'Few Walls Painting', text: 'Feature wall or accent wall painting for a quick refresh.' },
    ],
    highlights: [
      'Proper putty, sanding and priming before the first coat',
      'Furniture covered and floors masked — the site is left clean daily',
  ...
  /* ------------------------------------------------------------------ 04b */
  {
    ...
    subServices: [
      { name: 'Terrace Waterproofing', text: 'Membrane and slope treatment for exposed roof decks.' },
      { name: 'Bathroom Waterproofing', text: 'Floor and wall treatment before tiling, sealed at every junction.' },
      { name: 'Kitchen Waterproofing', text: 'Waterproofing for kitchen floors, counters and wet areas.' },
      { name: 'Balcony Waterproofing', text: 'Weather-exposed balcony and utility area treatment.' },
      { name: 'Basement Waterproofing', text: 'Below-grade treatment against seepage and rising damp.' },
      { name: 'Water Tank Waterproofing', text: 'Overhead and underground tank lining and sealing.' },
      { name: 'External Waterproofing', text: 'Exterior wall and facade damp-proofing against rain and seepage.' },
      { name: 'Wall Waterproofing', text: 'Internal and external wall treatment against damp and seepage.' },
    ],
    highlights: [
      'Correct membrane chosen for the surface, not one product for everything',
      'Slope and drainage checked before any coat goes on',
  ...
  /* ------------------------------------------------------------------ 06 */
  {
    ...
    gallery: ['/assets/services/electrical.svg'],
    subServices: [
      { name: 'Home Electrical Services', text: 'Complete electrical solutions for your home — wiring, fittings and repairs.' },
      { name: 'Fan Installation', text: 'Ceiling fan, exhaust fan and wall fan installation.' },
      { name: 'Light Installation', text: 'LED, panel, chandelier, spot and profile light installation.' },
      { name: 'Switches & Sockets', text: 'Modular switches and sockets — new points or replacement.' },
      { name: 'DB & MCB Installation', text: 'Distribution board, MCB and RCCB installation and protection.' },
      { name: 'Electricial Repair', text: 'Fix faults, short circuits, tripping and other electrical issues.' },
      { name: 'Wiring & Rewiring', text: 'New wiring or replacement of old wiring for homes and offices.' },
      { name: 'Appliance Installation', text: 'Geyser, chimney, AC point and other appliance electrical work.' },
    ],
    highlights: [
      'Point layout planned against your furniture plan, not guessed',
      'ISI-marked wire and branded switchgear specified in writing',
  ...
  /* ------------------------------------------------------------------ 07 */
  {
    ...
    gallery: ['/assets/services/plumbing.svg'],
    subServices: [
      { name: 'Toilet Installation', text: 'WC, cistern and complete toilet fixture installation.' },
      { name: 'Bathroom Installation', text: 'Complete bathroom plumbing — shower, WC, basin and fittings.' },
      { name: 'Tap & Faucet Installation', text: 'Tap, mixer, faucet and shower installation for kitchen and bathroom.' },
      { name: 'Basin & Sink', text: 'Wash basin, kitchen sink and counter sink installation.' },
      { name: 'Drainage & Blackage', text: 'Drainage line laying, blockage clearing and waste pipe installation.' },
      { name: 'Bathroomm Accessories', text: 'Towel rail, mirror, soap dish and other bathroom accessory fitting.' },
      { name: 'Water Tank Installation', text: 'Overhead or underground water tank and motor installation.' },
      { name: 'Leakage Repair & Connections', text: 'Leak tracing, pipe repair and new connections.' },
    ],
    highlights: [
      'Every concealed line pressure-tested before it is covered',
      'Branded CPVC pipe and fittings specified in the quotation',
  ...
  /* ------------------------------------------------------------------ 07b */
  {
    ...
    gallery: [],
    subServices: [
      { name: 'Architectural & Design', text: 'Complete architectural planning, 2D drawings and 3D visualisation.' },
      { name: 'Civil Construction', text: 'New construction, RCC work, brickwork, plaster and flooring.' },
      { name: 'Furniture Work', text: 'Modular kitchens, wardrobes, TV units, beds and custom furniture.' },
      { name: 'Fabrication', text: 'MS and SS fabrication — gates, railings, grills and staircases.' },
      { name: 'Finishing Work', text: 'Flooring, marble, granite, tiling and final touch-up.' },
    ],
    highlights: [],
    process: [],
    faqs: [],
